        ...
        private DataSet1 getData()
        {
            ...
            try {
                ...
                string sql = "SELECT  polizas_americanas.idFolio, polizas_americanas.folio, polizas_americanas.idCliente AS Expr2, "+ 
                    ...
                    " polizas_americanas.noLicencia2, polizas_americanas.edoLicencia, polizas_americanas.edoLicencia2, vehiculos_cliente.*, clientes.* FROM  polizas_americanas INNER JOIN clientes ON polizas_americanas.idCliente = clientes.idCliente INNER JOIN vehiculos_cliente ON polizas_americanas.idVehiculo = vehiculos_cliente.idVehiculo WHERE polizas_americanas.idFolio = " + folio;
